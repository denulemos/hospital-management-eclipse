...
public class GenerateReportAdmin extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        private JTextField fromMonth= new JTextField();
        private JTextField fromDay= new JTextField();
        private JTextField fromWeek= new JTextField();
        private JTextField toMonth= new JTextField();
        private JTextField toDay= new JTextField();
        private JTextField toWeek= new JTextField();
